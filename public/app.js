...
var COLUMNS = {
  ...
  basurales: [
    ...
    {sName: "denominacion", sTitle: "Denominación", fnRender: function(o) {
      return '<a href="/basurales/' + o.aData[0] + '">' + o.aData[o.iDataColumn] + '</a>';
    }},
    {sName: "direccion", sTitle: "Dirección"},
    {sName: "localidad_barrio", sTitle: "Localidad / Barrio"},
    {sName: "partido", sTitle: "Partido"},
    {sName: "clasificacion", sTitle: "Clasificación"},
    {sName: "sup_estimada_predio", sTitle: "Sup. estimada predio (m²)"},
    {sName: "sup_afectada", sTitle: "Sup. afectada (m²)"}
  ],

  asentamientos: [
    {sName: "id", bVisible: false},
    {sName: "nombre", sTitle: "Nombre", fnRender: function(o) {
      return '<a href="/asentamientos/' + o.aData[0] + '">' + o.aData[o.iDataColumn] + '</a>';
    }},
    {sName: "tipo", sTitle: "Tipo"},
    {sName: "inicio", sTitle: "Inicio"}
  ],

  reportes: [
    {sName: "id", bVisible: false},
    {sName: "title", sTitle: "Título", fnRender: function(o) {
      return '<a target="_blank" href="http://quepasariachuelo.crowdmap.com/reports/view/' + o.aData[0] + '">' + o.aData[o.iDataColumn] + '</a>';
    }},
    {sName: "description", sTitle: "Descripción"},
    {sName: "date", sTitle: "Fecha"},
    {sName: "category", sTitle: "Categoría"}
  ]
};
